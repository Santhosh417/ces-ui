<template>
  <b-container>
    ...
    <div class="content">
      <p>The University of Nebraska Omaha (Omaha or UNO) is a public research university in Omaha, Nebraska. Founded in
        1908 by faculty from the Omaha Presbyterian Theological Seminary as a private non-sectarian college, the
        university was originally known as the University of Omaha.</p>
      <p>UNO is Nebraska's metropolitan university — a university with strong academic values and significant
        relationships with our community that transforms and improves the lives of those on a local, regional, national,
    ...
    <b-row>
      ...
      <b-col>
        <img src="https://unothegateway.com/wp-content/uploads/2020/03/criss-libaray_ucomm-scaled.jpg" alt="Library"
             style="width:100%">
      </b-col>
      <b-col>
        <b-img src="https://www.unomaha.edu/college-of-arts-and-sciences/mathematics/_files/images/math%20lab2.JPG"
               alt="Classroom" style="width:100%"/>
      </b-col>
    </b-row>
    <div class="content">
      <p>UNO is dedicated to the city and state in our name. As the University of Nebraska's metropolitan university
        campus, no fences or barriers separate students from the opportunities offered by the greater Omaha area. We
        address real issues, providing relevant learning opportunities that uniquely prepare our graduates as
        professionals and active members of their community.</p>
    </div>
  </b-container>
</template>
